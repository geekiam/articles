...
publishDate: 2020-08-21T22:21:00.754Z
info:
  title: How to use package management in JavaScript projects
  ...
  keywords:
    ...
    - package management in node projects
twitter:
  ...
  cardImage:
    ...
    alt: " How to add project specific node package management configuration
      options"
tags:
  - javascript
  - nodejs
...
A package is basically a folder that contains scripts that can be run and used by JavaScript applications, which is to say that any folder that has some JavaScript code could basically be considered package, also commonly referred to as a 
Module.
...
A package manager or package-management system is a collection of software tools that automates the process of installing, upgrading, configuring, and removing computer programs or modules for operating systems or software projects 
...
![npm init questionaire](/media/images/javascript/geekiam-npm.png "npm init questionaire")

##### yarn init

![yarn init questionaire](/media/images/javascript/geekiam-yarn.png "yarn init questionaire")
...
![nvmrc file created](/media/images/javascript/nvmrc.png
/nvmrc.png "nvmrc file created")
...
![yarn install error](/media/images/javascript/yarn-install.png "yarn install error")
