...
publishDate: 2020-05-23T21:35:37.247Z
info:
  title: How to revert a git commit
...
twitter:
  ...
  cardImage:
    ...
    alt: How to use the git cli to revert an accidental commit
tags:
  - git
---
...
you to become a master](/basics-of-version-control "The Basics of version control| Geek.I.Am").  Using version control correctly can also help you recover and mitigate against making mistakes.
...
In order to illustrate this we're going to create a folder in our [Version Control Tutorial Repository](https://github.com/Geek-I-Am/version-control-tutorial) which we initially created in [How To Create A New Github Repository Using The Terminal](/how-to-create-a-new-github-repository-using-the-terminal/)
...
![Git Revert git reflog](/media/images/git/git-revert-1.png "git revert git reflog")
...
![git reflog](/media/images/git/git-reflog-1.png "git reflog screen shot")
...
![Git log ](/media/images/git/git-log1.png "git log screenshot")
...
![git reflog local change](/media/images/git/git-revert-2.png "git reflog local change terminal window")
